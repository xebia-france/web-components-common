...
import { getResponsiveKey, isNumber, isResponsiveProps } from '../../utils/functions';

class HeaderPicturesOnCorners extends Component {
    componentDidMount () {
        console.log('props on BlockText', this.props);
    }

    hasResponsiveProperty = props => isResponsiveProps(props) ? getResponsiveKey(props) : null
