...
import {Container, SubContainer, Card, PrevContainer, Title, Content, ImageContainer, CTA, Between} from './styled';
    ...
    getImages = field => {
        ...
        return field.content.images.map((image, i) => {
            ...
            if (!file) {
                ...
                return (
                      <PrevContainer><ImageContainer key={i}
        ...
        return (
            <Container>
                ...
                <Between responsive={Separator ? Separator.responsiveSettings : []}
                         ...
                         assetsDirectory={assetsDirectory}
                         basis={Separator && Separator.settings ? Separator.settings.basis : {}}><div/></Between>
