...
`;
export const PrevContainer = styled.div.attrs(props => ({
  ...
  // justify-content  : center;
   ...
   ${ props => props.responsive.map((size, i) => `
    ...
    : props.basis[size].size.minHeight || '' };      
            ...
            background-color:${ props.basisParent[size].color.rgb ?  `rgba(${props.basisParent[size].color.rgb},${props.basisParent[size].opacity.value})` : props.basisParent[size].color.hex };
